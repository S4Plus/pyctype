...
def parse(fmtstr):
    ...
    def read_stack():
        if stack_to_str(stack) == 's':
            add_type(format_unit.Str_s())
            clear_stack(stack)
        elif stack_to_str(stack) == 's*':
            add_type(format_unit.Str_s_s())
            clear_stack(stack)
        elif stack_to_str(stack) == 's#':
            add_type(format_unit.Str_s_p())
            clear_stack(stack)
        elif stack_to_str(stack) == 'z':
            add_type(format_unit.Str_z())
            clear_stack(stack)
        elif stack_to_str(stack) == 'z*':
            add_type(format_unit.Str_z_s())
            clear_stack(stack)
        elif stack_to_str(stack) == 'z#':
            add_type(format_unit.Str_z_p())
            clear_stack(stack)
        elif stack_to_str(stack) == 'y':
            add_type(format_unit.Str_y())
            clear_stack(stack)
        elif stack_to_str(stack) == 'y*':
            add_type(format_unit.Str_y_s())
            clear_stack(stack)
        elif stack_to_str(stack) == 'y#':
            add_type(format_unit.Str_y_p())
            clear_stack(stack)
        elif stack_to_str(stack) == 'u':
            add_type(format_unit.Str_u())
            clear_stack(stack)
        elif stack_to_str(stack) == 'u#':
            add_type(format_unit.Str_u_p())
            clear_stack(stack)
        elif stack_to_str(stack) == 'Z':
            add_type(format_unit.Str_Z())
            clear_stack(stack)
            ...
            add_type(format_unit.Str_w_s())
            clear_stack(stack)
        elif stack_to_str(stack) == 'es':
            add_type(format_unit.Str_es())
            clear_stack(stack)
        elif stack_to_str(stack) == 'et':
            add_type(format_unit.Str_et())
            clear_stack(stack)
        elif stack_to_str(stack) == 'es#':
            add_type(format_unit.Str_es_p())
            clear_stack(stack)
        elif stack_to_str(stack) == 'et#':
            add_type(format_unit.Str_et_p())
            clear_stack(stack)
        elif stack_to_str(stack) == 'O!':
            add_type(format_unit.Obj_O_e())
            clear_stack(stack)
        elif stack_to_str(stack) == 'O&':
            add_type(format_unit.Obj_O_a())
            clear_stack(stack)
            ...
            if tuple_depth:
                if c == '(':
                    ...
                    if tuple_depth == 0:
                        for typ in parse(stack_to_str(tuple_stack))[:-1]:
                            tuple_type.append(typ)
                        add_type(format_unit.Obj_t(tuple_type))
                    else:
                        for typ in parse(stack_to_str(tuple_stack))[:-1]:
                ...
                # numbers
                    ...
                    read_stack()
                    add_type(format_unit.Num_b())
                elif c == 'B':
                    read_stack()
                    add_type(format_unit.Num_B())
                elif c == 'h':
                    read_stack()
                    add_type(format_unit.Num_h())
                elif c == 'H':
                    read_stack()
                    add_type(format_unit.Num_H())
                elif c == 'i':
                    read_stack()
                    add_type(format_unit.Num_i())
                elif c == 'I':
                    read_stack()
                    add_type(format_unit.Num_I())
                elif c == 'l':
                    read_stack()
                    add_type(format_unit.Num_l())
                elif c == 'k':
                    read_stack()
                    add_type(format_unit.Num_k())
                elif c == 'L':
                    read_stack()
                    add_type(format_unit.Num_L())
                elif c == 'K':
                    ...
                    read_stack()
                    add_type(format_unit.Num_n())
                elif c == 'c':
                    read_stack()
                    add_type(format_unit.Num_c())
                elif c == 'C':
                    read_stack()
                    add_type(format_unit.Num_C())
                elif c == 'f':
                    read_stack()
                    add_type(format_unit.Num_f())
                elif c == 'd':
                    read_stack()
                    add_type(format_unit.Num_d())
                elif c == 'D':
                    read_stack()
                    add_type(format_unit.Num_D())
                # objects
                    ...
                    read_stack()
                    add_type(format_unit.Obj_O())
                elif c == '!' or c == '&':
                    stack.append(c)
                elif c == 'p':
                    read_stack()
                    add_type(format_unit.Obj_p())
                elif c == '(':
                    read_stack()
                    tuple_depth += 1
...
def print_signature(type_signature):
    output = []
    optional_output = []
    ...
    for item in type_signature:
        if not type(item) == list:
            ...
            for optional in item:
                optional_output.append(str(optional))

    output.append(optional_output)
    print(output)
